...
[![Render](https://img.shields.io/badge/Hosted%20on-Render-46E3B7?logo=render&logoColor=white)](https://fog-and-fern-san-francisco-k85u.onrender.com/)
...
**[Open Fog & Fern SF →](https://fog-and-fern-san-francisco-k85u.onrender.com/)**

> The Render-hosted demo may take a few moments to wake up if the service has been idle.
...
Fog & Fern SF is currently deployed on **Render**.

### Live deployment

**[https://fog-and-fern-san-francisco-k85u.onrender.com/](https://fog-and-fern-san-francisco-k85u.onrender.com/)**

### Render configuration

The application is deployed as a Node.js web service using:
...
All required `.env` values should be added in the Render dashboard under the service's environment-variable settings.

> On Render's free or idle-sleeping service tiers, the first request after inactivity can take a short time while the service starts.
...
![Fog & Fern shopping cart](screenshots/cart.PNG)

### 💳 Secure Checkout & Square Payment

![Fog & Fern Square payment gateway](screenshots/payment-gateway.PNG)

### ✅ Order Confirmation

![Fog & Fern order confirmation](screenshots/Confirmation.PNG)

### 📦 Purchase Summary & Order Journey

![Fog & Fern purchase summary](screenshots/purchase-summary.PNG)
...
![Fog & Fern customer registration](screenshots/register.PNG)

### 🔐 Customer Login

![Fog & Fern customer login](screenshots/login.PNG)

### 👤 Customer Account & Orders

![Fog & Fern customer account and orders](screenshots/orders.PNG)

### 🛠️ Admin Dashboard

![Fog & Fern admin dashboard](screenshots/admin.PNG)

> **Note:** GitHub paths are case-sensitive. Keep the screenshot filenames exactly as shown above inside the `screenshots` folder.
